...
namespace TravPense.Controllers
{
    public class DestinationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DestinationId,DestName")] Destination destination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinationId,DestName")] Destination destination)
        {
