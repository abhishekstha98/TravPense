...
namespace TravPense.Controllers
{
    public class HotelController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HotelId,HotName,Price,DestinationId")] Hotel hotel)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var hotel = await _context.hotel.SingleOrDefaultAsync(m => m.HotelId == id);
            if (hotel == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HotelId,HotName,Price,DestinationId")] Hotel hotel)
        {
            if (id != hotel.HotelId)
            {
                return NotFound();
