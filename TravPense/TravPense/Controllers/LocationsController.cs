...
namespace TravPense.Controllers
{
    ...
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("locid,Loctype,Destination")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("locid,Loctype,Destination")] Location location)
        {
